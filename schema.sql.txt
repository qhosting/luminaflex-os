...
-- NODO: qhosting_luminaflex-db
-- PROTOCOLO: 741 8 520 | AURUM_SHIELD_V2
-- NOTA: Toda interacción con esta DB debe priorizar la experiencia de "Tu Legado".
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status VARCHAR(20) DEFAULT 'Pendiente' CHECK (status IN ('Pendiente', 'Pagado', 'Proceso', 'Cancelado', 'Entregado')),
...
-- Inserción de Usuario Maestro CEO (Protocolo Aurum Master)
INSERT INTO users (email, password, role, status) 
VALUES ('ceo@luminaflex.mx', 'Aurum_741_Master', 'CEO', 'Online')
